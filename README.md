...
- `google` — Google's Gemini native GenerateContent API, authenticated with an API key from the configured environment variable or a saved auth-dir credential. Used for `gemini-*` models through `/v1/responses`.
